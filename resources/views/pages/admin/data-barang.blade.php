...
<body>
  ...
  <main id="main" class="main">
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <div class="d-flex align-items-center justify-content-end m-3">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambah-inventaris">
                  <i class="bi bi-plus-square"></i> Tambah
                </button>
              </div>

              <div class="table-responsive">
                <table class="table datatable" id="inventaris">
                  <thead>
                        ...
                        <tr>
                          ...
                          <td> 
                            @if($item->jenis == 'barang masuk')
                                <span class="badge rounded-pill bg-info">{{ $item->jenis }}</span>
                            @elseif($item->jenis == 'barang keluar')
                                <span class="badge rounded-pill bg-warning">{{ $item->jenis }}</span>
                            @endif
                          </td>
                          <td> {{ $item->stok }} </td>                        
    ...
    <!-- Modal Tambah Data -->
    <div class="modal fade" id="tambah-inventaris" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          ...
          <div class="modal-body">
            <div class="row">
              <div>
                ...
                <select name="produk" id="produk" class="form-select @error('produk') is-invalid @enderror">
                  ...
                  @foreach ($produk as $item)
                    <option value="{{ $item->id }}" {{ old('produk') == $item->id ? 'selected' : '' }}> {{ $item->nama_produk }} | Stok : {{ $item->stok }} </option>  
                  @endforeach
                </select>
                @error('produk') 
              ...
              <div class="col-md-6 mt-3">
                ...
                <input type="string" name="stok" class="form-control @error('stok') is-invalid @enderror shadow-none" id="stok" value="{{ old('stok') }}">
                @error('stok') 
                <div class="invalid-feedback">
                    {{ $message }}
                </div> 
              ...
              <div class="col-md-12 mt-3">
                <label id="catatan" class="form-label">Catatan Tambahan</label>
