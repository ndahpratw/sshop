...
<head>
  ...
  <title>{{ auth()->user()->role }} - {{ $title }} - {{ $sub_title }}</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{ route('pabrik.index') }}">{{ $title }}</a></li>
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <div class="d-flex align-items-center justify-content-between m-3">
                <h5 class="card-title">Total : {{ count($ratings) }} Ulasan Mengenai Produk Ini</h5>
              </div>
                  ...
                  <tbody>
                    @foreach ($ratings as $item)
                        <tr>
                          ...
                          <td> {{ $item->pembelian->produk->nama_produk }} </td>
                          <td> {{ $item->pembelian->produk->kategori->nama_kategori}} </td>
                          <td>
                            @if ($item->rating == 5)
